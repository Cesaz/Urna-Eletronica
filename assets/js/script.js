...
let seuVotoPara = document.querySelector('.d1_area_1 span');
let cargo = document.querySelector('.d1_area_2 span');
let descricao = document.querySelector('.d1_area_4');
let aviso = document.querySelector('.d2');
let lateral = document.querySelector('.d1_right');
let numeros = document.querySelector('.d1_area_3');
